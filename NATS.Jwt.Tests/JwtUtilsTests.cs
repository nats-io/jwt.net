...
namespace NATS.Jwt.Tests
{
	public class JwtUtilsTests
	{
		...
		public void Custom_fields()
		{
			...
			userClaim.Pub.Allow = new string[]
			{
				"pub-allow-subject"
			};
			userClaim.Pub.Deny = new string[]
			{
				"pub-deny-subject"
			};
			userClaim.Sub = new Permission();
			userClaim.Sub.Allow = new string[]
			{
				"sub-allow-subject"
			};
			userClaim.Sub.Deny = new string[]
			{
				"sub-deny-subject"
			};
			userClaim.Tags = new string[]
			{
				"tag1", "tag\\two"
			};
			...
			*/
			string expectedClaimBody =
				"{\"jti\":\"HLGJ6JO3YYHWQDUOPTLZCZQ5EUPS57PABGICO75ZNIMNEXZNIWIQ\",\"iat\":1633043378,\"iss\":\"ADQ4BYM5KICR5OXDSP3S3WVJ5CYEORGQKT72SVRF2ZDVA7LTFKMCIPGY\",\"name\":\"custom\",\"sub\":\"UA6KOMQ67XOE3FHE37W4OXADVXVYISBNLTBUT2LSY5VFKAIJ7CRDR2RZ\",\"nats\":{\"issuer_account\":\"ACXZRALIL22WRETDRXYKOYDB7XC3E7MBSVUSUMFACO6OM5VPRNFMOOO6\",\"tags\":[\"tag1\",\"tag\\\\two\"],\"type\":\"user\",\"version\":2,\"pub\":{\"allow\":[\"pub-allow-subject\"],\"deny\":[\"pub-deny-subject\"]},\"sub\":{\"allow\":[\"sub-allow-subject\"],\"deny\":[\"sub-deny-subject\"]},\"subs\":-1,\"data\":-1,\"payload\":-1}}";
			string expectedCred =
				"-----BEGIN NATS USER JWT-----\n" +
