...
One important takeaway from this project is that the purpose of the library is
...
Under that context, the ultimate validity of the JWT is delegated to tools or
